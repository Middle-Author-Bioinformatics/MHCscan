...
conda create -n magiclamp2 -c r r-dplyr r-tibble r-stringr r-fuzzyjoin r-RColorBrewer r-forcats r-plotly r-ggplot2 r-stringi r-reshape r-reshape2 r-tidyverse r-argparse r-ggdendro r-pvclust python=3.7 hmmer diamond prodigal blast metabat2 --yes
